...
const filePath = 'e:/Zomato_2/restaurant-ai/src/app/restaurants/[id]/page.tsx';
let content = fs.readFileSync(filePath, 'utf8');

const newReviews = \                {/* Aspect Analysis & AI Methodology */}
...
const regex = /<div className="mb-4 text-sm text-muted-foreground">[\\s\\S]*?<\\/section>/;
if (regex.test(content)) {
    content = content.replace(regex, newReviews + '\\n              </section>');
